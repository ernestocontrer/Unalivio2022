  ...
  render() {
    ...
    return (
      <div className={classes.section}>
        ...
        Los datos personales que se solicitan como nombre completo y correo electrónico, serán utilizados única y exclusivamente para dar un seguimiento personalizado a las solicitudes de información del sitio https://unalivio.com. Asimismo, te informamos que tus datos personales podrán ser transferidos y/o tratados por personas distintas a UNALIVIO S. A. P. I. DE C. V. con fines para mejorar la calidad de nuestro servicio y seguridad de nuestros usuarios.<br />
