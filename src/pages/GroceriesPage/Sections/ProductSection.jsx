...
class ProductSection extends React.Component {
  defaultState = {
    ...
    products: [ // this will be prefetched from firebase
      {name: "Cargando...", value: -1, price: {name: "Cargando...", value: -1}},
    ],
    method: '',
  ...
  refreshProducts = () => {
    if (this.props.firebase.apps.length == 0)
      ...
      products(this.props.firebase).list('combo').then(products => {
        if (!products) {
  ...
  render() {
    ...
    return (<div className={classes.background} id="combo">
