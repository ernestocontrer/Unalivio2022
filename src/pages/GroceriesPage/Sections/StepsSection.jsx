...
class StepsSection extends React.Component {
  render() {
    ...
    return (
      <div className={classes.background} id="tutorial">
          ...
          <GridContainer justify="center">
            <GridItem cs={12} sm={12} md={6}>
              ...
              <h4 className={classes.description}>
                Sólo sigue éstos{" "}
                <span style={{ fontWeight: "bold" }}>3 simples pasos</span>, y
                así podrás comprar productos para tus seres queridos en{" "}
                <span style={{ fontWeight: "bold" }}>Venezuela</span>. Te
                avisaremos por correo el estatus de tu compra y verificación de
                recepción para que siempre estés tranquilo.
              </h4>
              <GridContainer justify="center">
                <GridItem xs={12} sm={12} md={4}>
                  <InfoArea
                    title="Llena el formulario de compra para tu ser querido"
                ...
                <GridItem xs={12} sm={12} md={4}>
                  <InfoArea
                    title="Da click en ENVIAR y todo estará listo!"
