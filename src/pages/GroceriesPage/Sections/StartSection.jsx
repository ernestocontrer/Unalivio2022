      ...
      <div className={classes.section}>
        <GridContainer justify="center">
          <GridItem cs={12} sm={12} md={6}>
            <h2 className={classes.title}>¿Por qué el mercado de tus seres queridos con Unalivio?</h2>
            <h4 className={classes.description}>
              Al llenar el formulario sólo te pedimos tu email, el nombre y número
              de contacto para la entrega, monto en bolívares, combo a comprar a
