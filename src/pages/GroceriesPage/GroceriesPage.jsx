...
const GroceriesPage = ({ seo, classes, firebase, ...rest }) => (
  <MasterPage
    seo={SEO}
    poster="/bg.jpg"
    video={false}
        ...
        <GridContainer>
          <GridItem xs={12} sm={12} md={6}>
            <h1 className={classes.title}>
              Alivia a tus seres queridos en Venezuela con un mercado a
              domicilio
            </h1>
            <h4 className={classes.note}>
              <span style={{ fontWeight: "bold" }}>Unalivio</span> es la única
              plataforma que te comprar productos primordiales y entregarlos
              seres queridos en{" "}
